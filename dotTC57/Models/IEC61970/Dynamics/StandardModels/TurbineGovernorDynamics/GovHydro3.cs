...
namespace TC57CIM.IEC61970.Dynamics.StandardModels.TurbineGovernorDynamics {
	...
	public class GovHydro3 : TurbineGovernorDynamics {
		...
		/// <summary>
		/// Maximum gate opening, PU of MWbase (<i>Pmax</i>) (greater than GovHydro3.pmin).  Typical
		/// value = 1.
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.PU? pmax;
		/// <summary>
		/// Minimum gate opening, PU of <i>MWbase</i> (<i>Pmin</i>) (less than GovHydro3.pmax).
		/// Typical value = 0.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="GovHydro3"/> class
		/// </summary>
		public GovHydro3(){
