...
namespace TC57CIM.IEC61970.Dynamics.StandardModels.TurbineGovernorDynamics {
	...
	public class GovHydroFrancis : TurbineGovernorDynamics {
		...
		public float va;
		/// <summary>
		/// Maximum gate opening (<i>ValvMax</i>) (greater than GovHydroFrancis.valvmin).  Typical
		/// value = 1,1.
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.PU? valvmax;
		/// <summary>
		/// Minimum gate opening (<i>ValvMin</i>) (less than GovHydroFrancis.valvmax).  Typical
		/// value = 0.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="GovHydroFrancis"/> class
		/// </summary>
