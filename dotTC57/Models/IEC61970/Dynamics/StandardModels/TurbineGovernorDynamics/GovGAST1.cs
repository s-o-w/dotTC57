...
namespace TC57CIM.IEC61970.Dynamics.StandardModels.TurbineGovernorDynamics {
	...
	public class GovGAST1 : TurbineGovernorDynamics {
		...
		/// <summary>
		/// Maximum turbine power, PU of MWbase (<i>Vmax</i>) (greater than GovGAST1.vmin).  Typical
		/// value = 1.
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.PU? vmax;
		/// <summary>
		/// Minimum turbine power, PU of MWbase (<i>Vmin</i>) (less than GovGAST1.vmax).  Typical
		/// value = 0.
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.PU? vmin;

		/// <summary>
		/// Initializes a new instance of the <see cref="GovGAST1"/> class
		/// </summary>
		public GovGAST1(){
