...
namespace TC57CIM.IEC61970.Dynamics.StandardModels.ExcitationSystemDynamics {
	...
	public class ExcAC8B : ExcitationSystemDynamics {
		...
		/// <summary>
		/// Minimum exciter voltage output (<i>Vemin</i>) (less than or equal to 0).  Typical value = 0.
		/// </summary>
		...
		/// <summary>
		/// Input signal minimum (<i>Vimin</i>) (less than ExcAC8B.vimax).  Typical value = -10.
		/// </summary>
		...
		/// <summary>
		/// PID minimum controller output (<i>Vpidmin</i>) (less than ExcAC8B.vpidmax).  Typical
		/// value = -10.
		/// </summary>
		...
		/// <summary>
		/// Minimum voltage regulator output (<i>Vrmin</i>) (less than 0).  Typical value = 0.
		/// </summary>
