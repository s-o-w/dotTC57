...
namespace TC57CIM.IEC61970.Dynamics.StandardModels.PowerSystemStabilizerDynamics {
	...
	public class PssIEEE2B : PowerSystemStabilizerDynamics {
		...
		/// <summary>
		/// Input signal #1 minimum limit (<i>Vsi1min</i>) (less than vsi1max).  Typical
		/// value = -2.
		/// </summary>
		...
		/// <summary>
		/// Input signal #2 minimum limit (<i>Vsi2min</i>) (less than vsi2max).  Typical
		/// value = -2.
		/// </summary>
		...
		/// <summary>
		/// Stabilizer output minimum limit (<i>Vstmin</i>) (less than vstmax).  Typical
		/// value = -0,1.
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.PU? vstmin;

		/// <summary>
		/// Initializes a new instance of the <see cref="PssIEEE2B"/> class
		/// </summary>
		public PssIEEE2B(){
